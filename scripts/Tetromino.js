...
class Tetromino {
    ...
    drawSquare(x, y, size, color, borderColor) {
    ...
    draw(board) {
        ...
        const position = board.getCoordinates(
...
class TetrominoBag {
    ...
    init() {
        for (let i = 0; i < 3; i++) {
            this.threeNextT.push(this.getNext());
        }
    }
    fillBag() {
        const tetrominoType = [
    ...
    nextTetromino() {
        const next = this.threeNextT.shift();
        this.threeNextT.push(this.getNext());
        return next;
    }
    getThreeNextT(){
        return this.threeNextT;
    }
    reset() {
        this.bag = [];
        this.threeNextT = [];
